...
//  Quizzler
//
//  Created by Nicholas Feanny on 12/22/18.
//  Copyright © 2018 London App Brewery. All rights reserved.
//

import Foundation

//stores all the questions in the quiz app
//will be formatted using the question class
//each question within the bank will contain question texts as well as answers
